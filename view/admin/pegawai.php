...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Pegawai</h2>
            <!--// main-heading -->
            ...
            <section class="tables-section">
              <button type="button" name="button"></button>
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Daftar Pegawai</h4>
                              ...
                              if ($result->num_rows > 0) {
                                  while($row = $result->fetch_assoc()) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo  $row["peg_jabatan"]; ?></td>
                                        <td><?php echo  $row["peg_hp"]; ?></td>
                                        <td><?php echo  $row["peg_alamat"]; ?></td>
                                        <td><?php echo  $row["peg_tingkat"]; ?></td>
                                        <td></td>
